...
INSERT INTO `employee` (`employee_id`, `username`, `forename`, `surname`, `address`, `phone`, `email`, `e_type_id`, `active`, `password`, `salt`, `salary`, `commission`) VALUES
(1, 'chechter', 'Christian', 'Echtermeyer', 'Stibakken 2', '99258217', 'chrech.birr@gmail.com', 4, 1, 'dd1a1d47e15b4e2165f597ded84c05640c4506ba30d76a7d25e7726af37dc41e', 'YWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFh', 277.29, 0);
...
INSERT INTO `ingredient` (`ingredient_id`, `arrival_date`, `name`, `description`, `vegetarian`, `expire_date`, `amount`, `unit`) VALUES
...
INSERT INTO `recurring_order` (`rec_order_id`, `week_day`, `relative_time`, `subscription_id`, `food_package_id`, `amount`) VALUES
(1, 0, 81010, 1, 2, 1);
...
INSERT INTO `_order` (`_order_id`, `description`, `delivery_time`, `_order_time`, `portions`, `priority`, `salesperson_id`, `customer_id`, `rec_order_id`, `status`, `chauffeur_id`, `delivery_start_time`) VALUES
...
--
ALTER TABLE `dish`
  ADD CONSTRAINT `dish_ibfk_1` FOREIGN KEY (`dish_type_id`) REFERENCES `dish_type` (`dish_type_id`) ON UPDATE CASCADE;

--
-- Begrensninger for tabell `dish_food_package`
--
ALTER TABLE `dish_food_package`
  ADD CONSTRAINT `dish_food_package_ibfk_1` FOREIGN KEY (`dish_id`) REFERENCES `dish` (`dish_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `dish_food_package_ibfk_2` FOREIGN KEY (`food_package_id`) REFERENCES `food_package` (`food_package_id`) ON UPDATE CASCADE;

--
-- Begrensninger for tabell `employee`
--
ALTER TABLE `employee`
  ADD CONSTRAINT `employee_ibfk_1` FOREIGN KEY (`e_type_id`) REFERENCES `employee_type` (`e_type_id`) ON UPDATE CASCADE;

--
-- Begrensninger for tabell `ingredient_dish`
--
ALTER TABLE `ingredient_dish`
  ADD CONSTRAINT `ingredient_dish_ibfk_1` FOREIGN KEY (`ingredient_id`) REFERENCES `ingredient` (`ingredient_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `ingredient_dish_ibfk_2` FOREIGN KEY (`dish_id`) REFERENCES `dish` (`dish_id`) ON UPDATE CASCADE;
...
ALTER TABLE `timesheet`
  ADD CONSTRAINT `timesheet_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`employee_id`) ON UPDATE CASCADE;

--
-- Begrensninger for tabell `_order`
--
ALTER TABLE `_order`
  ADD CONSTRAINT `_order_ibfk_1` FOREIGN KEY (`rec_order_id`) REFERENCES `recurring_order` (`rec_order_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `_order_ibfk_2` FOREIGN KEY (`salesperson_id`) REFERENCES `employee` (`employee_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `_order_ibfk_3` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `_order_ibfk_4` FOREIGN KEY (`chauffeur_id`) REFERENCES `employee` (`employee_id`) ON UPDATE CASCADE;

--
-- Begrensninger for tabell `_order_food_package`
--
ALTER TABLE `_order_food_package`
  ADD CONSTRAINT `_order_food_package_ibfk_1` FOREIGN KEY (`_order_id`) REFERENCES `_order` (`_order_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `_order_food_package_ibfk_2` FOREIGN KEY (`food_package_id`) REFERENCES `food_package` (`food_package_id`) ON UPDATE CASCADE;
