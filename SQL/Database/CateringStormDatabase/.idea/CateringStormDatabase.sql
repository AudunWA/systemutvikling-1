...
CREATE TABLE location(
	...
	PRIMARY KEY location_pk (location_id,address)
);
...
CREATE TABLE _order_package(
	...
	FOREIGN KEY (package_id) REFERENCES package(package_id) ON UPDATE CASCADE,
	PRIMARY KEY (_order_id, package_id)
);
...
CREATE TABLE customer(
	...
	FOREIGN KEY (location_id, address) REFERENCES location (location_id, address) ON UPDATE CASCADE,
